...
public class ShowTariffPanelPageCommand implements Command {
    ...
    public CommandResult execute(HttpServletRequest request) {
        ...
        request.getSession().setAttribute("currentPage", "?command=tariffsPanel&sort=" + sortParameter);
        return new CommandResult(PagePath.TARIFF_PANEL_PAGE, CommandType.FORWARD);
    }
}
